...
class JingosScreenService;
class JingosPowerButton;
class JingosDisplay;
...
public:
    ...
    std::shared_ptr<JingosDisplay> the_jingos_display();
    std::shared_ptr<JingosScreenService> the_jingos_screen_service();
    std::shared_ptr<JingosPowerButton> the_jingos_power_button();
...
private:
    ...
    std::shared_ptr<JingosDisplay> jingos_display;
    std::shared_ptr<JingosPowerButton> jingos_power_button;
    std::shared_ptr<JingosScreenService> jingos_screen_service;
