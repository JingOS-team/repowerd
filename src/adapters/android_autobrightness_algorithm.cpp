...
try
{
    ...
    {
        printf("\e[0;36m[dba_error] %s:%d %s  %d %d %d %d \e[0m\n",__FILE__,__LINE__,__FUNCTION__,ab_light_levels.size(),ab_brightness_levels.size(),ab_brightness_levels.size(),ab_light_levels.size());
