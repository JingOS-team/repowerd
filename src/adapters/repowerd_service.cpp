...
char const* const dbus_repowerd_interface = "com.canonical.repowerd";
    ...
    GDBusMethodInvocation* invocation)
{
    ...
    if (method_name == "SetInactivityBehavior")
    {
        ...
        g_dbus_connection_emit_signal( dbus_connection,
                                    nullptr,
                                    dbus_repowerd_path,
                                    dbus_repowerd_interface,
                                    "InactivityBehaviorChange",
                                    g_variant_new("(&s&si)",power_action, power_supply,timeout),
                                    nullptr);
    }
