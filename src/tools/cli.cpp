...
std::unique_ptr<GDBusProxy,void(*)(void*)> create_jingos_screen_proxy()
{
    ...
    if (uscreen_proxy == nullptr)
    {
        throw std::runtime_error(
            "Failed to connect to com.jingos.repowerd.Screen: " + error.message_str());
    }
...
std::unique_ptr<GDBusProxy,void(*)(void*)> create_powerd_proxy()
{
    ...
    {
        throw std::runtime_error(
            "Failed to connect to com.jingos.powerd: " + error.message_str());
    }
...
int32_t keep_display_on(GDBusProxy* uscreen_proxy)
{
    ...
    {
        throw std::runtime_error(
            "com.jingos.repowerd.Screen.keepDisplayOn() failed: " + error.message_str());
    }
...
void remove_display_on_request(GDBusProxy* uscreen_proxy, int32_t cookie)
{
    ...
    {
        throw std::runtime_error(
            "com.jingos.repowerd.Screen.removeDisplayOnRequest() failed: " + error.message_str());
    }
...
std::string request_sys_state_active(GDBusProxy* powerd_proxy)
{
    ...
    {
        throw std::runtime_error(
            "com.jingos.powerd.requestSysState(active) failed: " + error.message_str());
    }
...
void clear_sys_state(GDBusProxy* powerd_proxy, std::string const& cookie)
{
    ...
    {
        throw std::runtime_error(
            "com.jingos.powerd.clearSysState() failed: " + error.message_str());
    }
...
try
{
    ...
    auto const uscreen_proxy = create_jingos_screen_proxy();
